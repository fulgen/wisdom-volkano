...
<head>
	<meta charset="utf-8" />
	<title>Timeseries MSBAS with Highcharts</title>
...
<body>
<div class="container">
  <h2>Timeseries MSBAS with Highcharts</h2>
...
$(function () {
  var tsv1 = $.get( "<?php echo base_url('assets/data/msbas/EW/Time_Series/VVP_ML_1_Pixel_FullSerie_238_370test_EW_Detrended.dat');?>" );
  var tsv2 = $.get( "<?php echo base_url('assets/data/msbas/UP/Time_Series/VVP_ML_1_Pixel_FullSerie_238_370test_UP._Detrended.dat');?>" );
